...
async def main():
    ...
    scope = {"type": "http", "method": "POST", "path": "/", "headers": [
        (b"host", b"paint-property-pro.preview.emergentagent.com"),
    ...
    html = captured["html"]
    url = f"https://paint-property-pro.preview.emergentagent.com/api/invoices/download/{fake.invoice_files.stored['token']}"
    checks = {
        "button in email html": "DOWNLOAD INVOICE PDF" in html,
        "link points at token url": url in html,
